...
export default function SidebarLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="relative h-[100dvh] flex flex-col overflow-hidden dark:bg-black bg-neutral-200"
            style={{
        ...
        >
            ...
            <nav className="shrink-0 relative flex items-center justify-between px-4 sm:px-6 py-2.5 sm:py-3 dark:bg-neutral-900/80 bg-white/80 backdrop-blur-md border-b dark:border-white/10 border-black/10 z-40">
                ...
                <div className="flex items-center">
                    ...
                    {/* Desktop logo */}
                    <Link href="/lobby" className="hidden lg:flex items-center gap-1">
                        <Image
                ...
                <Link href="/lobby" className="absolute left-1/2 -translate-x-1/2 lg:hidden flex items-center gap-1">
                    <Image
                        src="/chessMedia/checkmateLogo.png"
                        alt="Checkmate Logo"
                        width={120}
                    ...
                    />
                    <span className="font-bold text-xl tracking-tight dark:text-white text-neutral-900">CheckMate</span>
                </Link>
